...
Enter title value and budget value. Both inputs are required to create a category item.

Category items can be updated by double clicking on the items. Text inputs require values. Click update to update the category item.

Category items can be removed by clicking the remove button.
